    ...
    <div class="page-holder">
      ...
      <div class="container">
        ...
        <section class="py-5">
          ...
          <div class="row">
            <div class="col-lg-8">
              <form action="Function/buyers/insert.php" method="POST">
                <div class="row">
                  <div class="col-lg-6 form-group">
                    <label class="text-small text-uppercase" for="firstName">First name</label>
                    <input class="form-control form-control-lg" id="firstName" type="text" name="first_name[]" placeholder="Enter your first name">
                  </div>
                  <div class="col-lg-6 form-group">
                    <label class="text-small text-uppercase" for="lastName">Last name</label>
                    <input class="form-control form-control-lg" id="lastName" type="text" name="last_name[]" placeholder="Enter your last name">
                  </div>
                  <div class="col-lg-6 form-group">
                  ...
                  <div class="col-lg-6 form-group">
                    ...
                    <input class="form-control form-control-lg" id="phone" type="tel" name="phone[]"placeholder="e.g. +02 245354745">
                  </div>
                  <div class="col-lg-6 form-group">
                    <label class="text-small text-uppercase" for="company">Company name (optional)</label>
                    <input class="form-control form-control-lg" id="company" type="text" name="company_name[]" placeholder="Your company name">
                  </div>
                  <div class="col-lg-6 form-group">
                  ...
                  <div class="col-lg-12 form-group">
                    ...
                    <input class="form-control form-control-lg" id="address" type="text" name="address_line1[]" placeholder="House number and street name">
                  </div>
                  <div class="col-lg-12 form-group">
                    <label class="text-small text-uppercase" for="address">Address line 2</label>
                    <input class="form-control form-control-lg" id="addressalt" type="text" name="address_line2[]" placeholder="Apartment, Suite, Unit, etc (optional)">
                  </div>
                  <div class="col-lg-6 form-group">
                  ...
                  <div class="col-lg-12">
                    <div class="row d-none" id="alternateAddress">
                      ...
                      <div class="col-lg-6 form-group">
                        ...
                        <input class="form-control form-control-lg" id="firstName2" type="text" name="first_name[]" placeholder="Enter your first name">
                      </div>
                      <div class="col-lg-6 form-group">
                        <label class="text-small text-uppercase" for="lastName2">Last name</label>
                        <input class="form-control form-control-lg" id="lastName2" type="text" name="last_name[]" placeholder="Enter your last name">
                      </div>
                      <div class="col-lg-6 form-group">
                        <label class="text-small text-uppercase" for="email2">Email address</label>
                        <input class="form-control form-control-lg" id="email2" type="email" name="email[]" placeholder="e.g. Jason@example.com">
                      </div>
                      <div class="col-lg-6 form-group">
                        <label class="text-small text-uppercase" for="phone2">Phone number</label>
                        <input class="form-control form-control-lg" id="phone2" type="tel" name="phone[]" placeholder="e.g. +02 245354745">
                      </div>
                      <div class="col-lg-6 form-group">
                        <label class="text-small text-uppercase" for="company2">Company name (optional)</label>
                        <input class="form-control form-control-lg" id="company2" type="text" name="company_name[]" placeholder="Your company name">
                      </div>
                      <div class="col-lg-6 form-group">
                        <label class="text-small text-uppercase" for="country2">Country</label>
                        <select class="selectpicker country" id="country2" name="country[]" data-width="fit" data-style="form-control form-control-lg" data-title="Select your country"></select>
                      </div>
                      <div class="col-lg-12 form-group">
                        <label class="text-small text-uppercase" for="address2">Address line 1</label>
                        <input class="form-control form-control-lg" id="address2" type="text" name="address_line1[]" placeholder="House number and street name">
                      </div>
                      <div class="col-lg-12 form-group">
                        <label class="text-small text-uppercase" for="address2">Address line 2</label>
                        <input class="form-control form-control-lg" id="addressalt2" type="text" name="address_line2[]" placeholder="Apartment, Suite, Unit, etc (optional)">
                      </div>
                      <div class="col-lg-6 form-group">
                        <label class="text-small text-uppercase" for="city3">Town/City</label>
                        <input class="form-control form-control-lg" id="city3" name="city[]" type="text">
                      </div>
                      <div class="col-lg-6 form-group">
                        <label class="text-small text-uppercase" for="state4">State/County</label>
                        <input class="form-control form-control-lg" name="state[]" id="state4" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-12 form-group">
                ...
                <div class="card-body">
                  ...
                  <?php
                    ...
                    <li class="d-flex align-items-center justify-content-between">
                      <strong class="small font-weight-bold"><?=$product['name']?></strong>
                      <span class="text-muted small">$<?=$product['price']?></span>
                    </li>
                    <li class="border-bottom my-2"></li>
                    <?php } $_SESSION['totalPrice'] = $subtotal - ($subtotal*($discount/100)); ?>
                    <li class="d-flex align-items-center justify-content-between">
                      <strong class="text-uppercase small font-weight-bold">Total</strong>
                      <span>$<?=$_SESSION['totalPrice']?></span>
                    </li>
                  </ul>
                </div>
              </div>
